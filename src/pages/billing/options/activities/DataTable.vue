...
import ActivitiesDialog from 'components/billing/options/ActivitiesDialog.vue'
...
const showDeleteDialog = (id, name) => {
  ...
  deleteProps.value = {
    ...
    message: `¿Deseas eliminar la actividad ${name} de los registros?`,
    id: id,
    url: '/api/v1/billing/options/activities/',
  }
}
...
<template>
  <div>
    ...
    <template v-if="showForm !== 0">
      <BaseDialog :id="currentItem" :content="ActivitiesDialog" />
    </template>
