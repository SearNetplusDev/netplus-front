...
import EventDialog from 'components/accounting/dte/options/event/EventDialog.vue'
...
<template>
  <template v-if="showForm !== 0">
    <base-dialog :id="currentItem" :content="EventDialog" />
  </template>
    ...
    <template v-slot:body="{ props }">
      <q-tr :props="props">
        ...
        <q-td key="status" :props="props">
          <q-badge
            :color="props.row?.status ? 'primary' : 'red-10'"
            :label="props.row?.status ? 'Activo' : 'Inactivo'"
