...
import TypesDialog from 'components/configuration/clients/TypesDialog.vue'
...
const showDeleteDialog = (id, name) => {
  ...
  deleteProps.value = {
    ...
    id: id,
    url: '/api/v1/configuration/clients/types/',
  }
}
...
<template>
  <div>
    ...
    <template v-if="showForm !== 0">
      <BaseDialog :id="currentItem" :content="TypesDialog" />
    </template>
