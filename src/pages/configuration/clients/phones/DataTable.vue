...
import PhoneDialog from 'components/configuration/clients/PhoneDialog.vue'
...
const showDeleteDialog = (id, name) => {
  ...
  deleteProps.value = {
    ...
    id: id,
    url: '/api/v1/configuration/clients/phones/',
  }
}
...
<template>
  <div>
    ...
    <template v-if="showForm !== 0">
      <BaseDialog :id="currentItem" :content="PhoneDialog" />
    </template>
