...
import ContractsDialog from 'components/configuration/clients/ContractsDialog.vue'
...
const showDeleteDialog = (id, name) => {
  ...
  deleteProps.value = {
    ...
    id: id,
    url: '/api/v1/configuration/clients/contracts/',
  }
}
...
<template>
  <div>
    ...
    <template v-if="showForm !== 0">
      <BaseDialog :id="currentItem" :content="ContractsDialog" />
    </template>
