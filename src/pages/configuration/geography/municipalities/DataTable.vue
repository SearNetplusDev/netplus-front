...
import MunicipalityDialog from 'components/configuration/geography/municipalities/MunicipalityDialog.vue'
...
const showDeleteDialog = (id, name) => {
  ...
  deleteProps.value = {
    ...
    message: `¿Deseas eliminar el municipio ${name} de los registros?`,
    id: id,
    url: '/api/v1/configuration/geography/municipalities/',
  }
}
...
<template>
  <div>
    ...
    <template v-if="showForm !== 0">
      <BaseDialog :id="currentItem" :content="MunicipalityDialog" />
    </template>
